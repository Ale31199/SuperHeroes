...
const boody = () => {
	...
	return (
		<>
			...
			<div className="bg-slate-900 bg-opacity-95 rounded-xl absolute top-[280px] w-[95%] h-[65px] gap-y-10 p-4 md:w-[85%] flex justify-center items-center transition-all duration-500">
				<input
			...
			<div className="bg-black bg-opacity-95 rounded-xl absolute top-[350px] w-[95%] h-fit gap-y-10 p-4 md:w-[85%] grid xl:grid-cols-3  md:grid-cols-2 grid-cols-1 justify-items-center items-center transition-all duration-500  ">
